...
def _scipy_objective_and_grad(
    ...
    Args:
        ...
        property_dict: The property dictionary required to "unflatten" the
            input parameter vector, as generated by `module_to_array`.

    Returns:
        f: The objective value.
        grad: The gradient of the objective.
    """
