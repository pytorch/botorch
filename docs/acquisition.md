...
Although the approximated acquisition function is biased in this case, anecdotal
observations suggest that the location of optimizer itself somewhat robust to the bias.
...
`qExpectedImprovement` can be found in the
