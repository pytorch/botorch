...
get_ipython().run_line_magic('memit', 'X_chol, Y_chol = run_optimization(n_init, max_evals, batch_size, "cholesky", 10000, seed=seed)')
...
get_ipython().run_line_magic('memit', 'X_rff, Y_rff = run_optimization(n_init, max_evals, batch_size, "rff", 50000, seed=seed)')
...
get_ipython().run_line_magic('memit', 'X_ciq, Y_ciq = run_optimization(n_init, max_evals, batch_size, "ciq", 50000, use_keops=True, seed=seed)')
