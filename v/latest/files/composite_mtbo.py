...
# 
# See [the composite BO tutorial w/ HOGP](https://github.com/pytorch/botorch/blob/master/tutorials/composite_bo_with_hogp.ipynb) for a more technical introduction. In general, we suggest using MTGPs for unstructured task outputs and the HOGP for matrix / tensor structured outputs.
# 
# 
