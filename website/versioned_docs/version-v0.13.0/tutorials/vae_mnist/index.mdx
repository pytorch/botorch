...
<LinkButtons
  githubUrl="https://github.com/pytorch/botorch/blob/v0.13.0/tutorials/vae_mnist/vae_mnist.ipynb"
  colabUrl="https://colab.research.google.com/github/pytorch/botorch/blob/v0.13.0/tutorials/vae_mnist/vae_mnist.ipynb"
/>
