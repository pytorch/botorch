...
See [this documentation](../botorch_and_ax.md)
...
may want to
[write a custom acquisition function](./custom_acquisition/index.mdx)
and then
[use a custom zero-th order optimizer](./optimize_with_cmaes/index.mdx)
to optimize it.

<h4>Advanced Usage</h4>
Tutorials in this section showcase more advanced ways of using
BoTorch. For instance,
[this tutorial](./vae_mnist/index.mdx)
