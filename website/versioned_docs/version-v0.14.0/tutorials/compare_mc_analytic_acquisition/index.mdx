...
<LinkButtons
  githubUrl="https://github.com/cristianlara/botorch/blob/v0.14.0/tutorials/compare_mc_analytic_acquisition/compare_mc_analytic_acquisition.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/botorch/blob/v0.14.0/tutorials/compare_mc_analytic_acquisition/compare_mc_analytic_acquisition.ipynb"
/>
